...
```{r}
houstonMSA <- 
  st_read("data/UGB_Chapter_data/houston_MSA.shp") %>%
...
_JE Note: Don't use get_decennial - replace with get_acs. Will create a code vignette for this later. Will need to use na API key, though._
