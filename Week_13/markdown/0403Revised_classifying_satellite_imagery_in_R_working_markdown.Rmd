...
First we place points on what we identify as clouds in our image.
...
Do this iteratively and create objects for `water`, `developed`, `undeveloped` and then bind them together and call them `training_points`
