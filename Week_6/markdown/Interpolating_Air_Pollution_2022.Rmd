...
THIS IS A FISHNET WHAT IS A FISHNET AND HOW DO YOU MAKE IT
...
- Perform IDW and convert the raster to vector via Zonal Statistics as Table. 

- create an IDW_pred in the Mid_Atlantic_EPA_Dataset.
...
# Appendix - Creating The Fishnet in R and ArcGIS
