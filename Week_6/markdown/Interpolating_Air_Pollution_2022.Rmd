...
12. Join this table to `Mid_Atlantic_EPA_Dataset_withLag` by `FID`. Rename the "MEAN" field as `idw_pred`.
...
16. Join this table to `Mid_Atlantic_EPA_Dataset_withLag` by `FID`. Rename the "MEAN" field as `krige_pred`.
