...
If you have never used logistic regression, or "logit" modeling, make sure you read the class tutorial *Introduction to Applied Predictive Modeling* to see the basic workflow for training and testing models.
