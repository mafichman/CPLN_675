...
**Can you calculate how many fishnet grid cells are preserved?  What is it on a percentage basis? Can you re-scale slope to look at it how it varies from preserved/not-preserved?**
...
```{r load_parks, warning = FALSE, message = FALSE}
